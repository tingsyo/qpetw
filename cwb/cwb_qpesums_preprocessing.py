...
def main():
    ...
    parser.add_argument('--input', '-i', default='qpesums_source/', help='the directory containing the QPESUMS data.')
    parser.add_argument('--output', '-o', default='qpesums_lst_hwc/', help='the directory to store the output files.')

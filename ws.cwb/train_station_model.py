...
def init_model_mlc(input_shape):
    ...
    adam = Adam(lr=0.01, beta_1=0.9, beta_2=0.999, epsilon=1e-07, decay=0.01)
...
def main():
    ...
    parser.add_argument('--output', '-o', help='the perfix of output models.')
    ...
    model.save_weights(args.output+'_mlc_weights.h5')
    # done
    return(0)
